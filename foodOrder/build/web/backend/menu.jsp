...
<html>
    ...
    <body>
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.jsp">Hi! CodeGroup</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="slider.jsp"><i class="fa fa-fw fa-image"></i> Slider</a>
                    </li>
                    <li>
                        <a href="report.jsp"><i class="fa fa-fw fa-edit"></i> Reports</a>
                    </li>
                    <li>
                        <a href="siteadd.jsp"><i class="fa fa-fw fa-eye"></i>Site Adds</a>
                    </li>
