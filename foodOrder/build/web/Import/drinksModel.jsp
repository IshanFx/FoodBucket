...
<div id="drinksModel" class="modalor hide fade" tabindex="-1" role="dialog"
            ...
            <div class="col-lg-6 col-sm-6" style="float: left">
                ...
                <form class="form-horizontal">
                    <div class="control-group">
                        <label class="control-label" for="fistName">Size</label>
                        <div class="controls">
                            <select class=" input-xlarge element" placeholder="Your Name">
                                <option>100ml 200/=</option>
                                <option>200ml 300/=</option>
                                <option>400ml 400/=</option>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="radio">
                                <input type="radio" name="optionsRadios1" id="optionsRadios" value="option2"> with sugar
                            </label>
                            <label class="radio">
                                <input type="radio" name="optionsRadios1" id="optionsRadios1" value="option2">without sugar
                            </label>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="radio">
                                <input type="radio" name="optionsRadios" id="optionsRadios2" value="option2">with Ice cream
                            </label>
                            <label class="radio">
                                <input type="radio" name="optionsRadios" id="optionsRadios2" value="option2">without Ice cream
                            </label>
                        </div>
                    </div>
                    <div class="control-group">
